					...
					<div className="max-w-2xl mx-auto text-center">
						<div className="mb-8">
							...
							<p
								...
								style={{ lineHeight: "1.5" }}
							>
								Upload a PDF and start asking questions about
								its content. Get instant answers powered by AI.
							</p>
						</div>
						<Card
						...
						>
							<CardContent className="p-8 space-y-6">
								<div className="flex flex-col items-center space-y-4">
									<div className="p-4 rounded-full bg-gradient-to-br from-purple-100 via-white to-pink-100 shadow-lg">
										<Upload className="h-8 w-8 text-purple-400" />
									</div>
									<div className="text-center">
										<h3 className="text-lg font-semibold mb-2 font-ui text-gray-900">
											Upload your PDF
										</h3>
										<p className="mb-4 font-body text-gray-600">
								...
								<div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm font-ui text-gray-700">
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-4">
							<div className="flex items-center space-x-2">
								...
								/>
								<h1
									className="text-xl font-semibold font-ui"
									style={{ color: "#333333" }}
								>
									AskMyDoc
								</h1>
